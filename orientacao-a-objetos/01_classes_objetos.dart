...
/* 
  ...
  - ATRIBUTO: associado à caraterísticas.
  - MÉTODOS: associado à ações. 
*/
...
void main() {
  ...
  */
  ...
  aplicativo1.downloads = 690;
  aplicativo1.gratuito = true;

  print("O aplicativo ${aplicativo1.nome} tem ${aplicativo1.downloads} downloads.");
