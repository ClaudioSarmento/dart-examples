...
void reservarQuadra({
  ...
  print("Horário: $horario");     // false ? (incluirBola é true?) | : (senão )
...
void main() {
 ...
 configurarIconeApp(nomeApp: "Apple", corDeFundo: "Lilas");
 configurarIconeApp(nomeApp: "Shoppe", corDeFundo: "Laranja", iconeEm2D: true);
 configurarIconeApp(nomeApp: "Shein", corDeFundo: "Preto e Branco", iconeEm2D: false);

//Exemplo para praticar.
cadastroColaborador(nome: "Claudio", idade: 28);
cadastroColaborador(nome: "Gabriel", idade: 30, temFilhos: false);
cadastroColaborador(nome: "Maria", idade: 30, temFilhos: true);
...
void configurarIconeApp({
  ...
  print("--Configurar Icone App--");
  print("Nome: $nomeApp");
  print("Cor de Fundo: $corDeFundo");
  print("App em 2D: $iconeEm2D");
  print("---------//---------");
}
//Exemolos para praticar.
