...
void mostrarTipo(dynamic valor) {
  String tipo = valor.runtimeType.toString();  
  print("Valor: $valor = Tipo $tipo");
}
...
void main() {
  ...
  // Simulando um banco de dados flexível
  mostrarTipo("Seu valor"); // Texto
  mostrarTipo(8); // Número inteiro (Idade)
  mostrarTipo(true); // Booleano (Tem alergia?)
}
