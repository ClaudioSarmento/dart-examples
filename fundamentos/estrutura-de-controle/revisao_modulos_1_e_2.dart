  ...
  while (hpJogador > 0 && hpChefe > 0) {
    ...
    switch (acao) {
      ...
      case "3":
        ...
        case "4":
        print("\n=> Você está se defendeu!");
        estaDefendendo = true;
          break;
        

        case "5":
        print("Fúria de golpes");
       for (int repeticao = 1; repeticao <= 3; repeticao++){
          print("Golpe [1, 2, 3] acertou!");
        }
    ...
    if (hpChefe > 0 && acao !="5"){
      print("=> O Autômato atacou causando $danoChefe de dano!\n");
      hpJogador = hpJogador -5;
      }else{
        print("=> O Autômato furioso contra ataque causando $danoChefe de dano!\n");
        hpJogador = hpJogador - danoChefe ;
      }
