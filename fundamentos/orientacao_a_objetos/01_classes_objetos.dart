...
void main() {
  ...
  */
  Aplicativo Hollow_Knight = Aplicativo();
  Hollow_Knight.nomeApp = "Hollow Knight";
  Hollow_Knight.downloads = 1500000;
  Hollow_Knight.gratuito = false;
  if(Hollow_Knight.gratuito == false) {
    print("Nome: ${Hollow_Knight.nomeApp}, Downloads: ${Hollow_Knight.downloads}, Gratuito?: Não seu pobre");
  }else{
    print("${Hollow_Knight.nomeApp}, ${Hollow_Knight.downloads}, Sim");
  }
}