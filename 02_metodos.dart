...
void main() {
  ...
  */
  ...
  conta.titular = "Ana luiza";
  conta.deposistar(700000);
  conta.sacar(500);
...
class ContaBancaria {
  ...
  void deposistar(double valor){
    saldo += valor;
    print("O deposito é: \$${valor.toStringAsFixed(2)} Seu saldo atual é: \$${saldo.toStringAsFixed(2)}");
  }

  void sacar(double valor){
    if (valor <= saldo ){
      saldo -= valor;
      print("O valor de saque é: \$${valor.toStringAsFixed(2)} Seu saldo atual é: \$${saldo.toStringAsFixed(2)}");
    }else{
      print("Se caso o saldo for insuficiente: \$${valor.toStringAsFixed(2)} Seu saldo atual é: \$${saldo.toStringAsFixed(2)}");
    }
  }
