...
void main() {
  ...
  */
  ...
  // Escreva seu código abaixo desta linha:
   ...
   String diaDaSemanaNormalizado = diaDaSemana.toLowerCase(); // sexta

   print("Dia da semana informado pelo usuario: " + diaDaSemana);
   print("Dia da semana tratado pelo sistema (toLowerCase): " + diaDaSemanaNormalizado);
