...
void main() {
  ...
  */
  ...
  String diaDaSemana = "seGuNdA"; // sexta - SEXta - SEXTA;
  String diaDaSemanaNormalizado = diaDaSemana.toUpperCase();
  print("Usuario(a), informou: " + diaDaSemana);
  print("Nós normalizamos para: " + diaDaSemanaNormalizado);
