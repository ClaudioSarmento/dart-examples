...
void main() {
  ...
  // String cartaoSelecionado = "vendas_diarias";
  ...
  //     break;
  //   case "pedidos_bloqueados" || "tananan":
 ...
 String diaDaSemana = "SexTA"; // sexta ; SEXta SExtA 
 String diaDaSemanaNormalizado = diaDaSemana.toLowerCase();

 print("diaDaSemana informado pelo usuario: " +  diaDaSemana);
 print("diaDaSemanaNormalizado tratado pelo codigo: " +  diaDaSemanaNormalizado);
