...
void main() {
  ...
  */
  ...
  int Bateria_Celular = 5;

    print("Batéria: Bateria Celular ($Bateria_Celular) ");
     while (Bateria_Celular > 0) {
      print("Usando o celular $Bateria_Celular%");
      Bateria_Celular--; 
      
    }
      print("Celular descarregou");
