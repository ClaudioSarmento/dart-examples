  ...
  while (hpJogador > 0 && hpChefe > 0) {
    ...
    switch (acao) {
      ...
      case "3":
        ...
        // Reduz o dano do chefe pela metade
        int danoReduzido = (danoChefe / 2).round();
        print("=> O Autômato Furioso atacou, mas você defendeu e recebeu apenas $danoReduzido de dano!\n");
        hpJogador = hpJogador - danoReduzido;
        break;


      case "5":
        print("\n=> Você entrou em Fúria de Golpes!");
        for (int i = 1; i <= 3; i++) {
          print("Golpe $i acertou!");
          hpChefe = hpChefe - 10; // Cada golpe tira 10 de vida do chefe
          
        }
        hpJogador = hpJogador - 10; // Custa 10 de vida do jogador
