...
void criarPersonagem(String nomePersonagem, [String classe = "Guerreiro"]){
 print("Personagem criado com: $nomePersonagem com a classe $classe");
...
*/
  ...
  */
  ...
  criarPersonagem("Locão", "Alquimista");
  criarPersonagem("locão2 ");
}