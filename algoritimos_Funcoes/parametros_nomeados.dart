...
void configurarIconeApp({
   ...
   print("--- PERSONALIZAÇÃO DO APP ---");
   print("Nome do app: $nomeApp");
   print("Cor do fundo: $corDeFundo");
...
void main() {
 ...
 configurarIconeApp(nomeApp: "Tiktok", corDeFundo: "Preto");

 configurarIconeApp(nomeApp: "tiktok", corDeFundo: "Preto", iconeEm2D: false);
}