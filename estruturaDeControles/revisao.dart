...
void main() {
  ...
  // se o jogadador n por o nome ficara como Herói Anônimo
  ...
  //const valor ja conhecido pelo programa, ele é imutavel
  ...
  bool estaDefendendo = false;
    ...
    switch (acao) {
      ...
      case "4":
          print("\n=> Você levantou o escudo e se defendeu!");
          estaDefendendo = true;
          break;
          
      case "5":
          print("\n=> Você usou FÚRIA DE GOLPES!");
          ...
          print("=> Você perdeu 10 HP pelo cansaço!");
          break;    
    ...
    if (hpChefe > 0 && acao != "3") {
  if (estaDefendendo) {
    print("=> Você bloqueou o ataque do Autômato! Ele causou apenas 5 de dano!");
